...
class PBWB_Audio_Player extends WPBakeryShortCode {
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-audio-player', PBWB_ASSETS_URL.'css/audio-player.css', array(), null );
        $output .= wp_enqueue_script( 'pb-audio-player-script', PBWB_ASSETS_URL.'js/audio-player.js', array('jquery'), null, true );
