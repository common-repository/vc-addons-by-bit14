...
//                $i++;
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-counter-list', PBWB_ASSETS_URL.'css/counter-list.css', array(), null );
        $output .= wp_enqueue_script( 'pro-bit14-vc-addons-counter', PBWB_ASSETS_URL.'js/counter-script.js', array('jquery'), null, true );
