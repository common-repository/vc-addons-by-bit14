...
class PBWB_Headings extends WPBakeryShortCode {
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-heading', PBWB_ASSETS_URL.'css/heading.css', array(), null );
        $output .= wp_enqueue_script( 'pro-bit14-vc-addons-heading', PBWB_ASSETS_URL.'js/heading-script.js', array('jquery'), null, true );
