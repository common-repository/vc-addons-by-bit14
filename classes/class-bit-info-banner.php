...
class PBWB_Info_Banner extends WPBakeryShortCode {
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= '</div>';
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-info-banner', PBWB_ASSETS_URL.'css/info-banner.css', array(), null );
        $output .= wp_enqueue_script( 'pb-info-banner', PBWB_ASSETS_URL.'js/info-banner-script.js', array('jquery'), null, true );
