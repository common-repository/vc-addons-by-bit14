...
class WPBakeryShortCode_bit_pricing_table extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null){
        ...
        $html .= wp_enqueue_style( 'pro-bit14-vc-addons-pricing-table', PBWB_ASSETS_URL.'css/pricing-table.css', array(), null );
        $html .=wp_enqueue_script( 'pro-bit14-vc-addons-pricing-table', PBWB_ASSETS_URL.'js/pricing-table-script.js', array('jquery'), null, true );
        return $html;
