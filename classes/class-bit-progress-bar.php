...
class PBWB_Progress_Bar extends WPBakeryShortCode {
	...
	function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-progress-bar', PBWB_ASSETS_URL.'css/progress-bar.css', array(), null );
        $output .= wp_enqueue_script( 'pb-progress-bar-script', PBWB_ASSETS_URL.'js/progress-bar-script.js',  array('jquery'), null, true );
        $output .=  wp_enqueue_script( 'progress-bar', PBWB_ASSETS_URL.'js/jquery-ui.js', array('jquery'), null, true );
