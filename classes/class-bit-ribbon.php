...
class PBWB_Ribbon extends WPBakeryShortCode {
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-ribbon', PBWB_ASSETS_URL.'css/ribbon.css', array(), null );
        $output .= wp_enqueue_script( 'pb-ribbon-script', PBWB_ASSETS_URL.'js/ribbon.js', array('jquery'), null, true );
