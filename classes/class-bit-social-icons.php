...
function __construct(){
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $output .= wp_enqueue_style( 'pro-bit14-vc-addons-social-icon', PBWB_ASSETS_URL.'css/social-icon.css', array(), null );
        $output .= wp_enqueue_script( 'pb-social-icon-script', PBWB_ASSETS_URL.'js/social-icon.js', array('jquery'), null, true );
