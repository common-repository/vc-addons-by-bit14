...
class WPBakeryShortCode_bit_tab  extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = array() ) {
        ...
        $html .= wp_enqueue_style( 'pro-bit14-vc-addons-tabs', PBWB_ASSETS_URL.'css/tabs.css', array(), null );
        $html .= wp_enqueue_script( 'pro-bit14-vc-addons-tabs', PBWB_ASSETS_URL.'js/tabs.js', array('jquery'), null, true );
