...
class PBWB_Testimonial_Lists extends WPBakeryShortCode {
    ...
    function pbwb_shortcode_html($atts, $content = null){
        ...
        $data_attributes .=
        $tablet_num_slides ?
        ' data-tablet-display-columns='.$tablet_num_slides.'' :
                        ...
                        $output .= '<div itemscope itemtype ="http://schema.org/Review" class="bit-testimonial-container-pro" style="'.esc_attr($text_font_inline_style).'">';
                            ...
                            if ( $theme_style == 'testimonial-style-one-pro' ){
                                ...
                                if ( $media ){
                                    ...
                                    $output .= '<div itemprop="image" class="testimonial-author-image"><img src="'.plugin_dir_url(__DIR__) .'assets/images/dummy-person.png" /></div>';
                                }
                                // Author Details
       ...
       $output .= wp_enqueue_style( 'pro-bit14-vc-addons-team', PBWB_ASSETS_URL.'css/team.css', array(), null );        
       $output .= wp_enqueue_style( 'pro-bit14-vc-addons-testimonial-pro', PBWB_ASSETS_URL.'css/testimonial-pro.css', array(), null );
       $output .= wp_enqueue_style( 'slick-free', PBWB_ASSETS_URL.'css/slick.css', array(), null );
       $output .= wp_enqueue_script( 'bit14-vc-addons-free', PBWB_ASSETS_URL.'js/script.js', array('jquery'), null, true );
       $output .= wp_enqueue_script( 'slick-free', PBWB_ASSETS_URL.'js/slick.min.js', array('jquery'), null, true );
            return $output;
