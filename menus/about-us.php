    ...
    <div class="aboutus-page">
        ...
        <ul class="aboutus-menu-tabs">
            <li <?php echo ($action != "addons") ? esc_html($active) :""; ?>>
                <a href="admin.php?page=page_builder_addons_about_us"><?php esc_html_e("About Us","bit14") ?></a>
            </li>
        </ul>
        <div class="pane">
...
function pbwb_activate_addon() {
    ...
    if ( ! check_ajax_referer( 'pb_activate_nonce', 'security', false ) ) {
        wp_send_json_error( esc_html__( 'Your session expired. Please reload the page.', 'bit14' ) );
    }
...
function pbwb_install_addon() {
    ...
    if ( ! current_user_can( 'install_plugins' ) ) {
        wp_send_json_error( 'You do not have permission to install plugins.', 'bit14' );
    }
